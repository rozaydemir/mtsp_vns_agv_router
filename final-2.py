...
fileName = "utils/Instances/lrc104.txt"
customers = list()
num_customers = 0
corr_xy = list()
demands = list()
...
def readInstance(fileName):
    ...
    for line in f.readlines()[1:-6]:
        ...
        if lID.startswith("D"):  # depot ise
            ...
            #         pickup = Location(deliv.requestID, x, y, demand, startTW, endTW, servTime, servStartTime, "pickup",
            #                           nodeCount, lID)
            #         nodeCount += 1
            ...
            #         requests.append(req)
            #     else:
            #         deliv = Location(requestCount, x, y, demand, startTW, endTW, servTime, servStartTime, "delivery",
            #                          nodeCount, lID)
            #         nodeCount += 1
            #         requestCount += 1
